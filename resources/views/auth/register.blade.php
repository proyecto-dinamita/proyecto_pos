<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Usercode -->
        <div>
            <x-input-label for="usercode" :value="__('User Code')" />
            <x-text-input id="usercode" class="block mt-1 w-full" type="text" name="usercode" :value="old('usercode')" autocomplete="usercode" />
