                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.password') }}" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="firstname" class="form-label">Contraseña anterior</label>
                                            <input type="password" name="old_password" class="form-control @error('old_password') is-invalid @enderror" id="current_password">
                                            @error('old_password')
                                            <span class="text-danger"> La contraseña anterior es requerida </span>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            @error('new_password')
                                            <span class="text-danger"> Nueva contraseña es requerida o la confirmacion no coincide </span>
                                            @enderror
                                        </div>
                                    </div>
