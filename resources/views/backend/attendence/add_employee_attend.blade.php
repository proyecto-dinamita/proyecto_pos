                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <h4>
                                <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>Asistencia Empleados</a>
                            </h4>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('employee.attend.store') }}" method="post" id="myForm">
                            ...
                            <div class="form-group col-md-4">
                                <label for="date" class="control-label">Fecha asistencia</label>
                                    ...
                                    <tr id="div {{$employee->id}}" class="text-center">
                                        ...
                                        <td colspan="3">
                                            <div class="switch-toggle switch-3 switch-candy">
                                                <input class="present" id="present{{$key}}" name="attend_status{{$key}}" value="Presente" type="radio" checked="checked">

                                                <label for="present{{$key}}">Presente</label>
                                                <input class="leave" id="leave{{$key}}" name="attend_status{{$key}}" value="Fuera" type="radio">

                                                <label for="leave{{$key}}">Fuera</label>
                                                <input class="absent" id="absent{{$key}}" name="attend_status{{$key}}" value="Ausente" type="radio">
