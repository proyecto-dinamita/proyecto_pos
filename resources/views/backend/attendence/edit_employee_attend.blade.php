                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <h4>
                                ...
                                <a href="{{ route('employee.attend.list') }}" class="btn btn-primary float-sm-right"> <i class="fas fa-list"></i>Lista de asistencias</a>
                            </h4>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table sm table-bordered table-striped dt-responsive" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center" style="vertical-align: middle">Nombre</th>
                                        <th colspan="3" class="text-center" style="vertical-align: middle">Status</th>
                                    </tr>
                                    <tr>
                                        <th class="text-center btn present_all" style="display: table-cell;background-color:#114190">Presente</th>
                                        <th class="text-center btn leave_all" style="display: table-cell;background-color:#114190">Fuera</th>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td colspan="3">
                                            <div class="switch-toggle switch-3 switch-candy">
                                                <input class="present" id="present{{$key}}" name="attend_status{{$key}}" value="Presente" type="radio" {{ $item->attend_status == 'present' ? 'checked' : '' }}>
                                                <label for="present{{$key}}">Presente</label>

                                                <input class="leave" id="leave{{$key}}" name="attend_status{{$key}}" value="Fuera" type="radio" {{ $item->attend_status == 'Leave' ? 'checked' : '' }}>
                                                <label for="leave{{$key}}">Fuera</label>

                                                <input class="absent" id="absent{{$key}}" name="attend_status{{$key}}" value="Ausente" type="radio" {{ $item->attend_status == 'Absent' ? 'checked' : '' }}>
