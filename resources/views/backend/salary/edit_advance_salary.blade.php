                        ...
                        <div class="tab-pane" id="settings">
                            <form method="post" action="{{ route('advance.salary.update') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="firstname" class="form-label">Seleccione el mes</label>
                                            <select name="month" class="form-select @error('month') is-invalid @enderror" id="example-select">
                                                <option selected disabled>Select Month </option>
                                                <option value="Enero" {{ $salary->month == 'Enero' ? 'selected' : '' }}>Enero</option>
                                                <option value="Febrero" {{ $salary->month == 'Febrero' ? 'selected' : '' }}>Febrero</option>
                                                <option value="Marzo" {{ $salary->month == 'Marzo' ? 'selected' : '' }}>Marzo</option>
                                                <option value="Abril" {{ $salary->month == 'Abril' ? 'selected' : '' }}>Abril</option>
                                                <option value="Mayo" {{ $salary->month == 'Mayo' ? 'selected' : '' }}>Mayo</option>
                                                <option value="Junio" {{ $salary->month == 'Junio' ? 'selected' : '' }}>Junio</option>
                                                <option value="Julio" {{ $salary->month == 'Julio' ? 'selected' : '' }}>Julio</option>
                                                <option value="Agosto" {{ $salary->month == 'Agosto' ? 'selected' : '' }}>Agosto</option>
                                                <option value="Septiembre" {{ $salary->month == 'Septiembre' ? 'selected' : '' }}>Septiembre</option>
                                                <option value="Octubre" {{ $salary->month == 'Octubre' ? 'selected' : '' }}>Octubre</option>
                                                <option value="Noviembre" {{ $salary->month == 'Noviembre' ? 'selected' : '' }}>Noviembre</option>
                                                <option value="Diciembre" {{ $salary->month == 'Diciembre' ? 'selected' : '' }}>Diciembre</option>
                                            </select>
                                            @error('month')
