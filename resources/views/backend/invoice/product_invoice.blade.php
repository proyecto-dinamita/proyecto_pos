                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Factura</a></li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 offset-md-2">
                                <div class="mt-3 float-end">
                                    <p><strong>Fecha de compra : </strong> <span class="float-end"> &nbsp;&nbsp;&nbsp;&nbsp; Jan 17, 2016</span></p>
                                    <p><strong>Status de factura : </strong> <span class="float-end"><span class="badge bg-danger">Unpaid</span></span></p>
                                    <p><strong>Numero de factura. : </strong> <span class="float-end">000028 </span></p>
                                </div>
                            </div><!-- end col -->
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-6">
                                ...
                                <address>
                                    ...
                                    <br>
                                    <abbr title="Phone">Stock:</abbr> {{ $customer->shopname }}<br>
                                    <abbr title="Phone">Telefono:</abbr> {{ $customer->phone }}<br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="float-end">
                                    <p><b>Sub-total:</b> <span class="float-end">Q. {{ Cart::subtotal() }}</span></p>
                                    <p><b>Impuesto (12%):</b> <span class="float-end"> &nbsp;&nbsp;&nbsp; Q. {{ Cart::tax() }}</span></p>
                                    <h3>Q. {{ Cart::total() }} GTQ</h3>
                                </div>
                        ...
                        <div class="mt-4 mb-1">
                            <div class="text-end d-print-none">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#signup-modal">Crear factura </button>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card -->
